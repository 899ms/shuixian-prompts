...
- **人物**：真人/写实人物、动漫/二次元人物
- **非人物 15 类**：字体/排版/标题、Logo/品牌/VI、UI/App/网页/SaaS、产品/电商/包装、海报/广告/社媒、插画/艺术/概念、漫画/分镜/故事板、信息图/教育图解、3D/游戏/像素/等距、建筑/室内/空间、风景/自然、动物/宠物、车辆/机械/科幻、抽象/纹理/背景、其他/未归类

> 分类用于画廊筛选，也用于卡片配色 —— 17 类在 `css/base.css` 中各有一组配色变量。
> 「主题 × 风格」是另一套独立的多标签筛选维度。
